...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedBooking = yield booking_model_1.Booking.findByIdAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_interface_1.BOOKING_STATUS.COMPLETE }, { runValidators: true, session })
            .populate("tour", "title")
        ...
        const invoiceData = {
            ...
            totalAmount: (updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.amount) || 0,
        ...
        yield (0, sendEmail_1.sendEmail)({
            ...
            templateData: Object.assign(Object.assign({}, invoiceData), { invoiceUrl: cloudinaryResult.secure_url }),
            attachments: [
                {
